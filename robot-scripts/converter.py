def convert_to_robot_moves(solution="B1 R1 (2f)"):
    '''
    A funtion that converts cube moves to the robot move set.
        Parameters:
            solution (list): Solution move set in terms of cube
        Returns:
            new_solution (list): Robot move set
    '''
